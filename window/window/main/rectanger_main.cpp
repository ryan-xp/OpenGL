...
int main()
{
    ...
    mdel.ReadGlslFile("/home/json/zxp/OpenGL/window/glsl/rectangle/rectangle_v.glsl", VertextShaderString);
    const char * vertextShader = VertextShaderString.c_str();

    std::string FragmentShaderString;
    mdel.ReadGlslFile("/home/json/zxp/OpenGL/window/glsl/rectangle/rectangle_f.glsl", FragmentShaderString);
